...
export default function Leaderboard() {
  const { allTimeLeaderboard, myRankAllTime, loading, isAuthenticated } = useLeaderboard();
  const { user, isGuest } = useAuth();

  const currentLeaderboard = allTimeLeaderboard;
  const myRank = myRankAllTime;
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {isAuthenticated && myRank && (
          <section className="mb-8 sm:mb-12">
            <div className="card-interactive bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 p-4 sm:p-6">
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-bold text-lg">{myRank.xp}</span>
                    </div>
                    <div className="flex items-center gap-1">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 pb-3 border-b border-border">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-foreground">All-time Ranking</h2>
          </div>
        </div>
