...
export default function PoliticalTest() {
  ...
  // All questions are "answered" - even unanswered ones default to neutral (0)
          ...
          <div>
                ...
                {questions.filter(q => q.category === 'wirtschaft').map((question) => (
                  <div key={question.id} className="card-interactive p-4 sm:p-6">
                    ...
                    <div className="px-2">
                      ...
                      {/* Current Value - Always show, defaults to Neutral if not answered */}
                      <div className="text-center mt-2">
                        <span className={`text-sm font-semibold px-3 py-1 rounded-full inline-block ${
                          ...
                          {getScaleLabel(answers[question.id] ?? 0)}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex gap-3 mb-12">
              <button
                ...
                className="flex-1 py-3 sm:py-4 font-semibold rounded-lg btn-primary transition-all"
              >
                Ergebnis anzeigen
              </button>
              <button
                  ...
                  <div className="w-full aspect-square max-w-3xl flex items-center justify-center">
                    ...
                    >
                      ...
                      <text x="305" y="157" fontSize="15" fill="#111827" textAnchor="start" fontWeight="700">
                        <tspan x="305" dy="0">Markt-</tspan>
                        <tspan x="305" dy="18">wirtschaftlich</tspan>
                      </text>
