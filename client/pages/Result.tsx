    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-border">
        <div className="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-4">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-primary hover:opacity-80 transition-opacity mb-2 text-xs sm:text-sm"
          >
      ...
      <main className="flex-1 flex items-center justify-center px-2 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="w-full max-w-3xl">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
            {/* Correct Answers */}
            <div className="card-interactive bg-gradient-to-br from-green-50 to-green-100 border-green-200 p-3 sm:p-4 text-center">
              <div className="text-xs sm:text-sm text-green-600 font-semibold mb-1">
                Richtig
              </div>
              <div className="text-2xl sm:text-4xl font-bold text-green-700">
                {correctAnswers}
              </div>
