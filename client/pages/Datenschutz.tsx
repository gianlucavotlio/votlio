...
const datenschutzContent = `<h1>Datenschutz&shy;erkl&auml;rung</h1>
...
<h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>Gianluca Porta<br />
Sieglindenstrasse 20A<br />
86152 Augsburg</p>
<p>Telefon: 01758658909<br />
E-Mail: gianluca.votlio@gmail.com</p>
        ...
        <div className="max-w-4xl">
          <div
            className="prose prose-sm sm:prose max-w-none text-foreground leading-relaxed
              [&>h1]:text-3xl [&>h1]:sm:text-5xl [&>h1]:font-bold [&>h1]:text-blue-600 [&>h1]:mb-8 [&>h1]:sm:mb-12
              [&>h2]:text-xl [&>h2]:sm:text-2xl [&>h2]:font-bold [&>h2]:text-foreground [&>h2]:mt-8 [&>h2]:sm:mt-12 [&>h2]:mb-4
              [&>h3]:text-lg [&>h3]:sm:text-xl [&>h3]:font-bold [&>h3]:text-foreground [&>h3]:mt-6 [&>h3]:mb-3
              [&>h4]:text-base [&>h4]:sm:text-lg [&>h4]:font-semibold [&>h4]:text-foreground [&>h4]:mt-4 [&>h4]:mb-2
              [&>p]:text-base [&>p]:sm:text-lg [&>p]:mb-4 [&>p]:leading-7
              [&>ul]:list-disc [&>ul]:ml-6 [&>ul]:mb-4 [&>ul]:text-base [&>ul]:sm:text-lg
              [&>ul>li]:mb-2
              [&>a]:text-blue-600 [&>a]:hover:text-blue-700 [&>a]:hover:underline [&>a]:transition-colors"
