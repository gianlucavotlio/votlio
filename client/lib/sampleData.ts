  ...
  },
  {
    ...
    situations: [
      ...
      },
      {
        ...
        chapterId: "gesetzgebung",
        description:
          "Wahr oder Falsch: Der Bundespräsident kann ein vom Bundestag verabschiedetes Gesetz blockieren.",
        options: [
          {
            id: "option-6a",
            text: "Falsch",
            ...
            path: "established",
            feedbackText:
              "Richtig. Der Bundespräsident signiert Gesetze, kann sie aber nicht blockieren—das wäre verfassungswidrig (Art. 82 GG).",
          },
          {
            id: "option-6b",
            text: "Richtig",
            ...
            path: "independent",
            feedbackText:
              "Falsch. Der Bundespräsident hat kein Vetorecht. Er muss die Gesetze unterzeichnen.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    explanationCards: [
      ...
      },
      {
        ...
        title: "Gratulationen!",
        content:
          "Ausgezeichnet! Du hast das Modul 'Vertiefung & Analyse' erfolgreich abgeschlossen.\n\nDu hast dein Verständnis des Grundgesetzes auf akademisches Niveau vertieft und dabei gelernt:\n✓ Die Rechtshierarchie und den Verfassungsprimat\n✓ Wie das Grundgesetz geändert werden kann\n✓ Die historische Entwicklung von 1949 bis heute\n✓ Die Ewigkeitsklausel und ihre Bedeutung\n\nViel Erfolg bei deinem weiteren Lernweg!",
      },
    ],
    situations: [
      {
