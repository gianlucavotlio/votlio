...
export const GLOSSARY_TERMS: Record<string, GlossaryTerm> = {
  ...
  fraktionsdisziplin: {
    id: "fraktionsdisziplin",
    term: "Fraktionsdisziplin",
    definition:
      "Das Prinzip, dass Abgeordnete einer Fraktion bei Abstimmungen meist einheitlich abstimmen. Es sichert die Geschlossenheit einer Partei im Bundestag.",
  },
  fraktionsvorsitzende: {
    id: "fraktionsvorsitzende",
    term: "Fraktionsvorsitzende",
    definition:
      "Führungspersonen einer Fraktion im Bundestag. Sie verhandeln mit anderen Fraktionen, organisieren Abstimmungen und haben großen Einfluss auf Karrieren ihrer Abgeordneten.",
  },
  kontrollinstrumente: {
    id: "kontrollinstrumente",
    term: "Kontrollinstrumente",
    definition:
      "Werkzeuge der Opposition zur Kontrolle der Regierung. Dazu gehören Kleine und Große Anfragen sowie das Misstrauensvotum.",
  },
  misstrauensvotum: {
    id: "misstrauensvotum",
    term: "Misstrauensvotum",
    definition:
      "Ein Verfahren, bei dem der Bundestag der Regierung oder dem Bundeskanzler das Vertrauen entziehen kann. Ein konstruktives Misstrauensvotum ermöglicht die Abwahl des Kanzlers nur mit gleichzeitiger Wahl eines neuen.",
  },
};
